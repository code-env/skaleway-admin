        ...
        {value.map((url) => {
          return (
            ...
            >
              ...
              <Image fill alt="text" src={url} className="object-cover" sizes="100vw" />
            </div>
          );
        })}
      </div>
        ...
        {({ open }) => {
          ...
          return (
            <button
              disabled={disabled}
              onClick={onClick}
              className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 mb-3"
            >
              <ImagePlus size={20} />
